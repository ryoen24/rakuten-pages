...
\n\
  <div class="hn-mainvis">\n\
    <div class="hn-mainvis-slides slides-3">\n\
    ...
    <div class="hn-mainvis-overlay">\n\
      ...
      <p class="hn-mainvis-sub">伊豆高原の小さな隠れ宿で<br>日常を忘れ、心安らぐひとときを。</p>\n\
    </div>\n\
    <a href="#concept" class="hn-scroll-hint">Scroll</a>\n\
\n\
  </div>\n\
\n\
  ...
  <section class="hn-section hn-rooms">\n\
    <div class="hn-section-inner">\n\
      <div class="hn-title-area hn-sr">\n\
        ...
        <div class="hn-divider"></div>\n\
        <span class="hn-title-en-vert">Guest Rooms</span>\n\
        <h3 class="hn-subtitle">全客室露天風呂付</h3>\n\
        <p class="hn-desc">心やすらぐ、温もりの空間</p>\n\
        <div class="hn-more"><a href="#">view more</a></div>\n\
      </div>\n\
...
\n\
  <section class="hn-section hn-dining">\n\
    <div class="hn-dining-header" style="background-image: url(&quot;https://img.travel.rakuten.co.jp/share/image_up/28299/LARGE/5b8fb157e0d2a88a231596c6c7057120bc871871.47.1.26.2.jpg&quot;);">\n\
      <div class="hn-title-area"><h2 class="hn-title">食事<span class="en">Dining</span></h2></div>\n\
    </div>\n\
    <div class="hn-dining-body">\n\
      <div class="hn-title-area hn-sr">\n\
        <h3 class="hn-subtitle"><div>お食事は全て<span style="letter-spacing: 0.08em;">お部屋にて</span></div><div><span style="letter-spacing: 0.08em;">お召し上がりいただきます。</span></div><div>地元の食材を使い、<span style="letter-spacing: 0.08em;">伊豆を感じる</span></div><div><span style="letter-spacing: 0.08em;">お料理に仕上げました。</span></div></h3>\n\
        <p class="hn-desc">伊豆の恵みを味わう</p>\n\
        <div class="hn-more"><a href="#">view more</a></div>\n\
      </div>\n\
      <div class="hn-image-area hn-sr hn-sr-d1">\n\
        <div class="hn-slider">\n\
...
document.querySelectorAll('.hn-slider').forEach(function(slider){
  ...
  if(!track)return;
  var items=track.querySelectorAll('.hn-slider-item');
  var idx=0;
  function getCount(){var c=0;items.forEach(function(it){if(it.style.display!=='none')c++;});return c;}
  function go(i){var t=getCount();if(t<2)return;idx=((i%t)+t)%t;track.style.transform='translateX(-'+idx*100+'%)';}
  var prev=slider.querySelector('.hn-slider-arrow.prev');
  var next=slider.querySelector('.hn-slider-arrow.next');
  ...
  slider.addEventListener('mouseleave',function(){auto=setInterval(function(){go(idx+1);},5000);});
});
// Scroll Reveal
